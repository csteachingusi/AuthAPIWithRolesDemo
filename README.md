...
To login:
curl -X 'POST' 'https://127.0.0.1:7178/api/auth/login'   -H 'accept: */*' -H 'Content-Type: application/json'   -d '{  "email": "yan@usi.edu",  "password": "Test123+"}'

curl -X 'POST' 'https://127.0.0.1:7178/api/auth/register'   -H 'accept: */*' -H 'Content-Type: application/json'   -d '{  "email": "yan@usi.edu",  "password": "Test123+"}'
